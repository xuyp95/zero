...
var UserTable = function() {
    ...
    oTableInit.Init = function () {
        $('#authUserTable').bootstrapTable({
            ...
            height: $(window).height() - $(".nav-tabs").height() -$(".main-footer").height()-$(".toolbar-div").height()-$(".panel").height() - $(".navbar-static-top").height() - 50,   //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
        ...
        callback: function(result) {
            if (result) {
                $.ajax({
                    ...
                    error: function(XHR, ERRO_MSG) {
                        ZeroDialog.error("错误信息", "处理异常");
                    }
                })
            }
        }
